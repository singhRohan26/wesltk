                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" >
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('vendor/edit-service-menu/'. $category['id']);?>" data-toggle="tooltip" title="Edit Menu"><i class="fa fa-edit"></i></a>&emsp;
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="error_msg"></div>
                                         <?php 
                                                ...
                                                if(!empty($menu_data)){
                                                    echo form_open_multipart('vendor/editServiceMenu/'.$menu_data['id'], $content);
                                                }else{
                                                    echo form_open_multipart('vendor/addServiceMenu', $content);
                                                }
                                            ?>
