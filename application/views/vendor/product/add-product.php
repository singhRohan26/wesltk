				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							if(!empty($product)){
								echo form_open_multipart('vendor/doEditShopProduct/'.$product['id'], $content);
							}else{
								echo form_open_multipart('vendor/doAddShopProduct', $content);
							}
							?>
							<div class="row">
                                <div class="col-sm-6">
									<div class="form-group">
										<h5 class="font-size-14">Choose Product Category</h5>
										<select class="form-control" id="product_menu" name="product_menu">
							...
							<div class="row">
                                ...
                                <div class="col-sm-6">
									<div class="form-group">
										...
										<input class="form-control" value="<?php if(!empty($product)) { echo $product['price']; }?>" type="text" name="quantity" id="quantity" placeholder="Quantity....">
									</div>
								</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										...
										?>
											<a class="text-danger" href="<?php echo base_url('vendor/delete-product-image/'. $image['id']);?>"><i class="fa fa-trash"></i></a>
