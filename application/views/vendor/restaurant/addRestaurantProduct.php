			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">Restaurant Product</h4>
						<ol class="breadcrumb m-0">
							<li class="breadcrumb-item"><a href="<?php echo base_url('vendor/dashboard');?>">Dashboard</a></li>
							<li class="breadcrumb-item"><a href="<?php echo base_url('vendor/restaurant-product');?>">Back</a></li>
						</ol>
					</div>
				</div>
			</div>     
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							if(!empty($product)){
								echo form_open_multipart('vendor/doEditProduct/'.$product['id'], $content);
							}else{
								echo form_open_multipart('vendor/doAddProduct', $content);
							}
							?>
							<div class="row">
                                <div class="col-sm-6">
