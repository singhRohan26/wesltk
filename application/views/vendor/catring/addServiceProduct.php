				...
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						...
						<ol class="breadcrumb m-0">
							...
							<li class="breadcrumb-item"><a href="<?php echo base_url('vendor/service-catring-product');?>">Back</a></li>
						</ol>
					</div>
				</div>
			</div>     
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							if(!empty($product)){
								echo form_open_multipart('vendor/doEditServiceCatringProduct/'.$product['id'], $content);
							}else{
								echo form_open_multipart('vendor/doAddServiceCatringProduct', $content);
							}
							?>
							<div class="row">
                                <div class="col-sm-6">
