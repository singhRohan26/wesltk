                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" >
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('vendor/edit-service-catring-menu/'. $category['id']);?>" data-toggle="tooltip" title="Edit Menu"><i class="fa fa-edit"></i></a>&emsp;
                                                    <a href="<?php echo base_url('vendor/delete-service-menu/'. $category['id']);?>" data-toggle="tooltip" title="Delete Menu" class="delete-item"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                           <?php
                                                $i++;
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="error_msg"></div>
                                         <?php 
                                                ...
                                                if(!empty($menu_data)){
                                                    echo form_open_multipart('vendor/editCatringServiceMenu/'.$menu_data['id'], $content);
                                                }else{
                                                    echo form_open_multipart('vendor/addServiceCatringMenu', $content);
                                                }
                                            ?>
