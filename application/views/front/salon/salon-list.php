				...
				<div class="restaurntRight boxs">
					...
					<div class="resturaRightHead">
						...
						<div class="searchFood searchFood2">
							<input type="text" class="form-control search-restaurant" data-url="<?php echo base_url('home/search-salon');?>" placeholder="Search for a food, product & services">
					...
					<div class="menuDetail menu1 active restaurant-wrapper" data-url="<?php echo base_url('home/salonWrapper');?>">
