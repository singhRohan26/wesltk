		...
		<div class="container">
			<div class="resturaRightHead resturaRightHead2">
				...
				<div class="searchFood searchFood3 searchFood2">
					<input type="text" class="form-control serach-product" data-url="<?php echo base_url('home/salon-product/'. $restaurant['vendor_id']);?>" placeholder="Search for a food, product & services">
