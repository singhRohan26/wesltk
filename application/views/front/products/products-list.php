<!--restaurants banner code start-->
	<section class="restaurBanner  scrollTop boxs">
		...
		<div class="restBanCont">
			<div class="container">
				<h2>386 Shops For Your Location</h2>
			</div>
		</div>
	</section>
			...
			<div class="resturentData">
				...
				<div class="restaurntRight boxs">
					...
					<div class="resturaRightHead">
						<div class="restHeadd">
							<h2>Shops <span>(386)</span></h2>
						</div>
						<div class="searchFood searchFood2">
							<input type="text" class="form-control search-restaurant" data-url="<?php echo base_url('home/search-restaurant');?>" placeholder="Search for a food, product & services">
					...
					<div class="menuDetail menu1 active restaurant-wrapper" data-url="<?php echo base_url('home/productWrapper');?>">
