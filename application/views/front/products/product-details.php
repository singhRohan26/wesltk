	...
	<section class="restaurantDet scrollTop paddingAll   boxs">
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					<div class="restImgs">
						<img src="<?php echo base_url('uploads/vendor/'.$shop['image']); ?>" class="img-fluid" alt="resturant">
					</div>
				</div>
				<div class="col-sm-6">
					<div class="detailContent">
						...
						<h2 class="new"><?php echo $shop['name'] ?></h2>
						<p>North Indian, Mughlai, Seafood, Biryani, Desserts, Kebabs</p>
						<div class="OrderDetail">
							<ul>
								<li>Minimum Order Amount :</li>
								<li>$ <?php echo $shop['min_amount'] ?></li>
							</ul>
							<ul>
								<li>Working Hours Today :</li>
								<li><?php echo $shop['working_hours'] ?></li>
							</ul>
							<ul>
								<li>Delivery Time :</li>
								<li><?php echo $shop['delivery_time'] ?></li>
							</ul>
			...
			<div class="resturaRightHead resturaRightHead2">
				<div class="resturantMenu resturantMenu2 res_menu_type">
					<ul>
						...
						<li><a href="#0" data-id='3' data-url="<?php echo base_url('home/shop_product_img/'. $shop['vendor_id'].'/'.$type='products');?>">Photos</a></li>
					</ul>
				</div>
				<div class="searchFood searchFood3 searchFood2">
					<input type="text" class="form-control serach-product" data-url="<?php echo base_url('home/search-product/'. $shop['vendor_id']);?>" placeholder="Search for a food, product & services">
		...
		<div class="container">
			<div class="resturentData resturentData2 active view1 boxs">
				...
				<div class="restaurntRight restaurntRight2 view1 boxs">
					<div>
						<div class="menuDetail menuShow product-wrapper1" data-url="<?php echo base_url('home/shop-product-listing/'. $shop['vendor_id']);?>">
