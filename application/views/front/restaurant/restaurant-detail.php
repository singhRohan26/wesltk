		...
		<div class="container">
			<div class="resturaRightHead resturaRightHead2">
				...
				<div class="searchFood searchFood3 searchFood2">
					<input type="text" class="form-control serach-product" data-url="<?php echo base_url('home/search-product/'. $restaurant['vendor_id']);?>" placeholder="Search for a food, product & services">
		...
		<div class="container">
			<div class="resturentData resturentData2 active view1 boxs">
				<div class="resturantLeft resturantLeft2">
					<div class="restarLeft restarLeft22">
						<div class="radio restaurant_veg_type">
							<input id="radio-11" name="radio" type="checkbox" value="Veg">
							<label for="radio-11" class="radio-label ">Veg Only<span class="foodType"><img src="<?php echo base_url('public/front/');?>img/veg.svg" class="img-fluid" alt="veg"></span></label>
						</div>

						<div class="radio restaurant_veg_type">
							<input id="radio-12" name="radio" type="checkbox" value="Non-veg">
							<label for="radio-12" class="radio-label">Non Veg<span class="foodType"><img src="<?php echo base_url('public/front/');?>img/nonveg.svg" class="img-fluid" alt="veg"></span></label>
						</div>
					</div>
				...
				<div class="restaurntRight restaurntRight2 view1 boxs">
					<div>
						<div class="menuDetail menuShow product-wrapper1" data-url="<?php echo base_url('home/product-listing/'. $restaurant['vendor_id']);?>">
