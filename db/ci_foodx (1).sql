...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2020 at 04:27 AM
...
--
-- Table structure for table `catring_booking`
--

CREATE TABLE `catring_booking` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `catring_booking`
--

INSERT INTO `catring_booking` (`id`, `user_id`, `name`, `email`, `phone`, `date`) VALUES
(1, 1, 'Ram', 'ram@gmail.com', '7458868452', '2020-09-19');
...
(22, 0, 0, 0, 0, 1, 2, 'Ram', '100', 'The standard Lorem Ipsum passage, used since the 1500s\r\n\"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laboru', 'Veg', 0, 'services', 'Active', '0'),
...
--
-- Indexes for table `catring_booking`
--
ALTER TABLE `catring_booking`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `catring_booking`
--
ALTER TABLE `catring_booking`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
